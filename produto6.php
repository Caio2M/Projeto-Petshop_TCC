...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto6.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Petisco Whiskas Temptations para Gatos Adultos Sabor Salmão - 40g </h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>Este petisco Whiskas certamente será do agrado de todo e qualquer felino. As características de destaque da guloseima são:
                - Crocante por fora e macia por dentro;
                - Irresistível e único no sabor;
                - Feito para aumentar a conexão entre você e o pet. 
                Temos certeza de que o bichano será muito grato a você depois de prová-lo.
                
            </h3>

            <!-- COLOCAR O PREÇO DO PRODUTO -->
            <h1 class="preco">R$ 9,09 </h1>

...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto22.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Cama M1 Urban Puppy para Cães Microfibra Lisa Marinho</h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>- Indicada para cães e gatos;
                - Enchimento removível;
                - Fibra siliconada;
                - Estampa exclusiva;
                - Super confortável e quentinha,

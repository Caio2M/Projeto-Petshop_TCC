...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto1.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Ração Golden Gatos Adultos Carne - 10,1kg </h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>A Ração Golden Gatos Adultos Carne é tudo que seu gato precisa para ficar diariamente satisfeito.
                Elaborada com nobres proteínas, a ração é rica em taurina, o que ajuda a manter os olhos e coração do seu gato saudáveis. Além disso, a ração auxilia no trato urinário do seu animal, pois possui minerais balanceados em sua fórmula.
                Não bastasse isso, a Ração Golden Adultos Sabor Carne é livre de corantes e aromatizantes artificiais, proporcionando ao seu gato uma alimentação mais natural e balanceada.
            </h3>

            <!-- COLOCAR O PREÇO DO PRODUTO -->
            <h1 class="preco">R$ 139,41</h1>

...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto18.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Shampoo Pet Society Pelos Claros para Cães e Gatos - 300ml</h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>- Indicado para cães;
                - Previne manchas e evita que os fios fiquem amarelados;
                - Possui ingredientes concentrados;
                - Secagem rápida;
                - PH balanceado e fácil enxágue.
                
            </h3>

            <!-- COLOCAR O PREÇO DO PRODUTO -->
            <h1 class="preco">R$51,99</h1>

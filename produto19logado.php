...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto19.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Cama Pawise para Gatos Deluxe Round</h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>- Indicada para gatos;
                - Design inovador;
                - Super aconchegante e macia;
                - Confeccionada com material resistente,
                - Proporciona mais conforto na hora do descanso.

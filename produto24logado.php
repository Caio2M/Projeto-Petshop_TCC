...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto24.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Cama Fábrica Pet Oval Unic Azul para Cães e Gatos</h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>- Indicada para cães e gatos;
                - Confeccionada para dar muito mais conforto;
                - Torna os momentos de descanso e soninho do seu pet mais aconchegante;
                - Possui almofada removível com zíper para a retirada do enchimento, facilitando a sua   lavagem;
                - Disponível nos tamanhos P, M, G, GG e EXG. 
                                     
            </h3>

            <!-- COLOCAR O PREÇO DO PRODUTO -->
            <h1 class="preco">R$79,99</h1>

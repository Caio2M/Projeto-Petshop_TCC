...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto15.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Shampoo Ibasa Bio Defense para Cães e Gatos - 200ml</h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>- Indicado para cães e gatos;
                - Ideal para higienizar e hidratar a pele e pelagem;
                - Produto com foco no tratamento e manutenção da disbiose;
                - Possui prebióticos que estimulam o desenvolvimento das bactérias benéficas do microbioma residente;
                - Na composição há componentes hidratantes para auxiliar na hidratação, como d-pantenol, alantoína e óleo de abacate;
                - Auxilia na hidratação e equilíbrio da pele.                                 
                                                                     
            </h3>

            <!-- COLOCAR O PREÇO DO PRODUTO -->
            <h1 class="preco">R$84,99 </h1>

...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto16.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Clorexsyn Shampoo Antisséptico para Cachorro e Gatos Konig - 200ml</h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>Alguns animais podem ter a pele um pouco mais sensível que o normal. Por isso, ficam vulneráveis às infecções causadas por fungos e bactérias. Para evitar esse tipo de problema, foi desenvolvido o shampoo Clorexsyn para cães e gatos!
                Ideal para o tutor que deseja ver o amigo de quatro patas limpinho e protegido, o Clorexsyn da Konig apresenta várias vantagens, como:
                - Possui ação antisséptica e desinfetante para a pele;
                - Atua na recuperação de doenças bacterianas e fúngicas;
                - Oferece um tratamento prático e indolor.                                               
                                                                     
            </h3>

            <!-- COLOCAR O PREÇO DO PRODUTO -->
            <h1 class="preco">R$48,90</h1>

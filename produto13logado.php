...
<body>
    ...
    <main>
        ...
        <div class="imagem"><img src="img/produtos/produto13.png" alt=""></div>

        <div class="texto01">

            <!-- COLOCAR O NOME DO PRODUTO-->
            <h2>Shampoo I Love Pet Gato para Gatos - 500ml </h2>

            <!-- COLOCAR INFORMAÇÕES DO PROTUDO -->
            <h3>- Indicado para gatos;
                - Contém em sua formulação silicone e creatina;
                - Possui pH neutro.
                                                                     
            </h3>

            <!-- COLOCAR O PREÇO DO PRODUTO -->
            <h1 class="preco">R$33,99</h1>
